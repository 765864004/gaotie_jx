<?php if (!defined('THINK_PATH')) exit();?><div class="pageContent"  style="height:485px;overflow-y:auto;">
    <form  class="pageForm required-validate"  action="<?php echo U('admin/ks_manage/taskpagefpAdd');?>" onsubmit="return validateCallback(this,dialogAjaxDone)" method="post" >
    <table id="UserListTable" class="list" style="width:100%;">
        <tbody>
            <tr>
                ...
                <td align="left">
                    <select name="paperid">
                        <?php if(is_array($pageList)): $i = 0; $__LIST__ = $pageList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pagePo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($pagePo['autoid']); ?>"><?php echo ($pagePo['name']); endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </td>
            </tr>
            <!--  -->
