<?php if (!defined('THINK_PATH')) exit();?>﻿<div class="pageHeader">
    <form id="pagerForm" action="<?php echo U('admin/admin_manage/userList');?>" method="post" onSubmit='return navTabSearch(this);' class="pageForm required-validate">
        ...
        <div id='search'>
            ...
            <select name="departid">
                ...
                <?php if(is_array($departList)): $i = 0; $__LIST__ = $departList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$departVo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($departVo['id']); ?>" <?php if($departid == $departVo['id']):?>selected<?php endif;?>><?php echo ($departVo['name']); endforeach; endif; else: echo "" ;endif; ?>
            </select>
...
<div class="pageContent">
   <div class="panelBar">
	    <ul class="toolBar">
	        <li><a class="add" href="<?php echo U('admin/admin_manage/userAdd');?>" target="dialog" width="510" height="250" mask=true title='添加学员'><span>添加</span></a></li>
	        <li><a class="edit" href="<?php echo U('admin/admin_manage/userEdit');?>?id={sid}" target="dialog" width="510" height="250" mask=true warn="您没有选中" title='编辑学员'><span>修改</span></a></li>
	        <li class="line">line</li>
	        <li><a class="delete" href="<?php echo U('admin/admin_manage/userDel');?>?id={sid}&actType=del" target="ajaxTodo" warn="您没有选中" title="确定要删除吗？"><span>删除</span></a></li>
	        <li class="line">line</li>
	        <li><a title="导入EXCEL"  target="dialog" href="<?php echo U('admin/admin_manage/userPlExcel');?>" class="icon" width="510" height="140"><span>导入EXCEL</span></a></li>
	    </ul>
	</div>
