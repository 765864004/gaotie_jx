<?php if (!defined('THINK_PATH')) exit();?><div class="pageContent">
    <form  class="pageForm required-validate"  action="<?php echo U('admin/dictionary_manage/materialAdd');?>" onsubmit="return validateCallback(this,dialogAjaxDone)" method="post" >
    <table id="UserListTable" class="list" style="width:100%;">
        <tbody>
            ...
            <tr>
                ...
                <td align="left"><input type='text' name='tipname'  class="required"/></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
